...
A library of Project Templates to be used with Octopus Deploy's Platform Hub.

## Usage

Find a project template that matches your needs and copy the `.ocl` file to your `.octopus/project-templates` folder.
...
If you create a new template then please follow these instructions.

1. Create a new folder with the template name in the appropriate folder.
2. Copy in the `.ocl` of the template into that new folder.
3. Create a `README.md` for the template.  The file should include the following.  See `ExampleReadMe.md` in this folder.
   ...
   4. List known limitations about the template.
...
If you improve or iterate on a template then please follow these instructions.

1. Update the `.ocl` of the template.
